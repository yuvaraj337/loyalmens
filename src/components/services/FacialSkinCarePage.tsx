...
const FACIAL_SERVICES: FacialCardItem[] = [
  {
    id: 'f1',
    name: 'Basic Facial',
    ...
    <div className="haircut-page" id="facial-skin-care-page">
      ...
      <main className="haircut-container">
        ...
        <nav className="category-breadcrumb" aria-label="Breadcrumb">
          <span style={{ color: '#A89B8E', marginRight: '2px' }}>|</span>
          <a href="/">Home</a>
          <span className="category-breadcrumb-sep">&gt;</span>
          <a href="/services">Services</a>
          <span className="category-breadcrumb-sep">&gt;</span>
          <span className="category-breadcrumb-current">Facial &amp; Skin Care</span>
        </nav>

        {/* ==================================================================
            3. HERO SECTION
            ================================================================== */}
        <section className="haircut-hero-section" aria-label="Facial & Skin Care Introduction">
          <div className="haircut-hero-grid">
            {/* Left Hero Column */}
            <div className="haircut-hero-left">
              <span className="haircut-hero-eyebrow">FACIAL &amp; SKIN CARE</span>
              <h1 className="haircut-hero-heading">
                <span className="haircut-heading-line">Facial &amp;</span>
                <span className="haircut-heading-line haircut-heading-accent">Skin Care</span>
              </h1>
            ...
            <div className="haircut-hero-right">
              <div className="haircut-hero-img-wrap">
                <img
                  src="/images/facial/hero_facial_photo.jpg"
                  alt="Healthy Skin A Sharper You - Facial & Skin Care"
        ...
        {/* ==================================================================
            4. FACIAL BENEFITS STRIP
            ================================================================== */}
        <section className="haircut-benefit-strip" aria-label="Facial Benefits">
        ...
        {/* ==================================================================
            5. OUR FACIAL SERVICES SECTION (3-COLUMN CARDS)
            ================================================================== */}
        <section className="haircut-services-section" aria-label="Our Facial Services Menu">
          <div className="haircut-services-header">
            <div className="haircut-services-title-col">
              <span className="haircut-services-eyebrow">OUR FACIAL SERVICES</span>
              <div className="haircut-services-heading-row">
                <h2 className="haircut-services-heading">Our Facial Services</h2>
                <span className="haircut-services-heading-line" />
              </div>
              <p className="haircut-services-subtitle">
                Professional skin care therapies for the modern man.
              </p>
            </div>
          </div>

          <div className="facial-services-grid">
            {FACIAL_SERVICES.map((svc) => (
              <div key={svc.id} className="facial-service-card">
                <div className="facial-card-left">
                  <img
                    src={svc.thumb}
                    alt={svc.name}
                    className="facial-card-thumb"
                    loading="lazy"
                  />
                  <div className="facial-card-info">
                    <span className="facial-card-title">{svc.name}</span>
                    <span className="facial-card-desc">{svc.desc}</span>
                    <span className="facial-card-price">{svc.price}</span>
                  </div>
                </div>
      ...
      {/* ==================================================================
          7. LUXURY LIGHT FOOTER (FACIAL VARIANT)
          ================================================================== */}
...
export default FacialSkinCarePage;
